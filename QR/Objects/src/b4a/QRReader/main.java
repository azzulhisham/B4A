...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.QRReader", "b4a.QRReader.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.QRReader", "b4a.QRReader.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.QRReader.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public b4a.QRReader.starter _starter = null;
...
mostCurrent._qrcrv.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 51;BA.debugLine="DoEvents";
anywheresoftware.b4a.keywords.Common.DoEvents();
 //BA.debugLineNum = 52;BA.debugLine="qrcrv.startScan";
...
public static String  _b2_click() throws Exception{
 ...
 //BA.debugLineNum = 56;BA.debugLine="qrcrv.stopScan";
mostCurrent._qrcrv.stopScan();
 //BA.debugLineNum = 57;BA.debugLine="DoEvents";
anywheresoftware.b4a.keywords.Common.DoEvents();
 //BA.debugLineNum = 58;BA.debugLine="qrcrv.Visible = False";
mostCurrent._qrcrv.setVisible(anywheresoftware.b4a.keywords.Common.False);
...
public static String  _qrcrv_result_found(String _retval) throws Exception{
 //BA.debugLineNum = 61;BA.debugLine="Sub qrcrv_result_found(retval As String)";
 //BA.debugLineNum = 62;BA.debugLine="Log(\"B4A: \" & retval)";
anywheresoftware.b4a.keywords.Common.LogImpl("3524289","B4A: "+_retval,0);
 //BA.debugLineNum = 63;BA.debugLine="l1.Text = retval";
