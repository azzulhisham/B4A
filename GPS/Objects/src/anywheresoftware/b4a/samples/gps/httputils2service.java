...
public class httputils2service extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "anywheresoftware.b4a.samples.gps", "anywheresoftware.b4a.samples.gps.httputils2service");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "anywheresoftware.b4a.samples.gps.httputils2service", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
_job = (anywheresoftware.b4a.samples.gps.httpjob)(_taskidtojob.Get((Object)(_taskid)));
...
anywheresoftware.b4a.keywords.Common.LogImpl("61572870","HttpUtils2Service: job completed multiple times - "+BA.NumberToString(_taskid),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("61507329",("ResponseError. Reason: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_reason))+", Response: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_response.getErrorResponse()))+""),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("61507333","HttpUtils2Service (hc_ResponseError): job completed multiple times - "+BA.NumberToString(_taskid),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("61376259","HttpUtils2Service (hc_ResponseSuccess): job completed multiple times - "+BA.NumberToString(_taskid),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("61114119",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 //BA.debugLineNum = 35;BA.debugLine="Log(\"Switching to File.DirInternal\")";
anywheresoftware.b4a.keywords.Common.LogImpl("61114120","Switching to File.DirInternal",0);
...
public static String  _submitjob(anywheresoftware.b4a.samples.gps.httpjob _job) throws Exception{
int _taskid = 0;
