...
public class starter extends android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "b4a.QRReader14", "b4a.QRReader14.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.QRReader14.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
public b4a.QRReader14.main _main = null;
