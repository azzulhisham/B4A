...
public class httputils2service extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "b4a.MyFirstHelloAndroid", "b4a.MyFirstHelloAndroid.httputils2service");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.MyFirstHelloAndroid.httputils2service", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
public b4a.MyFirstHelloAndroid.main _main = null;
...
_job = (b4a.MyFirstHelloAndroid.httpjob)(_taskidtojob.Get((Object)(_taskid)));
...
anywheresoftware.b4a.keywords.Common.LogImpl("8851974","HttpUtils2Service: job completed multiple times - "+BA.NumberToString(_taskid),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("8786437","HttpUtils2Service (hc_ResponseError): job completed multiple times - "+BA.NumberToString(_taskid),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("8655363","HttpUtils2Service (hc_ResponseSuccess): job completed multiple times - "+BA.NumberToString(_taskid),0);
...
public static String  _submitjob(b4a.MyFirstHelloAndroid.httpjob _job) throws Exception{
int _taskid = 0;
