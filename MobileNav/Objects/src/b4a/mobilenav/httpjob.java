...
public class httpjob extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.mobilenav.httpjob");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.mobilenav.httpjob.class).invoke(this, new Object[] {null});
        else
...
__c.LogImpl("92293772",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("92555912","Cannot send files from the assets folder.",0);
...
String _value = "";
String _s = "";
b4a.mobilenav.httpjob._multipartfiledata _fd = null;
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
...
_fd = (b4a.mobilenav.httpjob._multipartfiledata)(group17.Get(index17));
